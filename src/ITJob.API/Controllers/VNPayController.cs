...
public class VNPayController : ControllerBase
{
    ...
    public VNPayController(IConfiguration configuration, IWalletRepository walletRepository)
    {
    ...
    {
        string returnContent = "GD Khong thanh cong";
        if (Request.Query.Count > 0)
        {
            ...
            //Cap nhat ket qua GD
            //Yeu cau: Truy van vao CSDL cua  Merchant => lay ra duoc Wallet
            //Giả sử Wallet lấy ra được như giả lập bên dưới
            //get from DB
            var wallet =
